...
class Motorcycle(models.Model):
    ...
    latitude = models.FloatField(default=0.0)  # GPS Latitude (-90 to 90)
    longitude = models.FloatField(default=0.0) # GPS Longitude (-180 to 180)

    def update_location(self, latitude, longitude):
        """Updates the motorcycle's GPS location."""
